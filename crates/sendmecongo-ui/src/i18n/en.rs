...
pub static TEXT: Text = Text {
    ...
    snd_repair_title: "Repair broadcast (resume)",
    snd_repair_hint: "Paste the receiver's repair code and only the missing part is replayed",
    snd_repair_placeholder: "SMR1-XXXX-XXXX-XXXX-XXXX-…",
    snd_repair_ok: "Match: replaying {} symbols (about {}% of a full cycle)",
    snd_repair_invalid: "Invalid repair code: {}",
    snd_repair_mismatch: "The repair code does not match the current file or preset",
    ...
    rcv_partial_title: "Not complete yet — progress saved",
    rcv_partial_needed: "{} / {} distinct symbols, about {} more to go",
    rcv_partial_eta: "Refilming at {} ≈ {}",
    rcv_repair_code: "Repair code",
    rcv_repair_code_hint: "Type this into the sender's repair box and it replays only the missing part",
    rcv_copy: "Copy",
    rcv_copied: "Copied",
    rcv_grid_title: "Symbol reception",
    rcv_grid_legend: "filled = received, empty = missing",
    rcv_block_label: "Source block {}",
    rcv_auto_resume: "Checkpoint found — continuing from the previous {} symbols",
    rcv_back: "Back",
